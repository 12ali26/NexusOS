...
stage_desktop_runtime() {
	...
	local -a runtime_files=(
		...
		"desktop/scripts/nexus-desktop-doctor.sh"
		"desktop/scripts/nexus-install-apt.sh"
		"desktop/scripts/nexus-install-appimage.sh"
		"desktop/scripts/nexus-install-deb.sh"
		"desktop/scripts/nexus-install-downloaded-debs.sh"
		"desktop/scripts/nexus-install-selected-app.sh"
		"desktop/scripts/nexus-open-in-editor.sh"
		"desktop/scripts/nexus-register-app.sh"
		"desktop/scripts/nexus-set-default-app.sh"
