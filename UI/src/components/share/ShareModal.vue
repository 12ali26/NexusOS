	...
	<div class="modal-card">
		...
		<header class="modal-card-head">
			<div class="is-flex-grow-1">
				<h3 class="title is-3">{{ $t('Share Nexus Cloud') }}</h3>
			</div>
			<div>
		...
		<section class="modal-card-body ">
			<div class="node-card  mt-5 mb-5">
				...
				<div class="buttons is-justify-content-center mb-6 mt-4">
					<ShareNetwork v-for="site in shareSites" :key="site" :description="shareTitle"
								  :network="site"
								  :title="shareTitle" :url="projectUrl" hashtags="homecloud,opensource">
...
export default {
	...
	data() {
		return {
			timer: 0,
			updateTimer: 0,
			projectUrl: `https://github.com/12ali26/NexusOS`,
			shareTitle: `I'm using Nexus Cloud, a browser-accessible personal computer based on CasaOS.`,
			shareSites: [
				'facebook',
				'twitter',
				'reddit'
